...
def run_test_largest_number():
    ...
    # Test 4:
    expected =131
    answer = largest_number(([11], [13], [131]))
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    contain = -99999999999999999999999999999999999
    for j in range(len(seq_seq)):
        for k in range(len(seq_seq[j])):
            if seq_seq[j][k] > contain:
                contain = seq_seq[j][k]
    if contain == -99999999999999999999999999999999999:
        return None
    else:
        return contain
...
def run_test_largest_negative_number():
    ...
    expected = -1
    answer = largest_negative_number([(-31, -1, 4),
                             (13, -10, -11, 7, 10),
                             [1, -2, 3, -4]])
    print('Expected and actual are:', expected, answer)
    ...
    # Test 4:
    expected = -131
    answer = largest_negative_number(([], [132], [-131]))
    print('Expected and actual are:', expected, answer)
